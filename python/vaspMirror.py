...
def main():
    ...
    reflect_positions_direct = cartesian_to_direct(unmirror["lattice_matrix"],
                                                   reflect_positions_cartesian)
    mapping = mapping_elements(unmirror["elements"],
                               unmirror["atom_counts"],
                               reflect_positions_cartesian,
                               reflect_positions_direct,
                               unmirror["species"],
                               unmirror["selective_dynamics"],
                               unmirror["flags"])
    labels = define_labels(mapping["elements"],
                           mapping["atom_counts"])
    write_POSCAR(argv[2],
                 unmirror["lattice_matrix"],
                 mapping["elements"],
                 mapping["atom_counts"],
